...
namespace BatSmasher.Scenes
{
    ...
    {
        private const string DUNGEON_TEXT = "Bat";
        private const string SLIME_TEXT = "Smasher";
        ...
        public override void LoadContent()
        {
            ...
            _uiSoundEffect = Core.Content.Load<SoundEffect>("audio/MMX - Stage Cursor Move");
            if (Core.Audio.SoundEffectVolume == 1) 
            {
                Core.Audio.SoundEffectVolume = Core.Audio.SoundEffectVolume - .90f;
            }

            // Load the texture atlas from the xml configuration file.
            _atlas = TextureAtlas.FromFile(Core.Content, "images/atlas-definition-2.xml");
        }
