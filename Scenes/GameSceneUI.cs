...
using MGLibrary.Input;
using System;

namespace BatSmasher.UI
{
    public class GameSceneUI : ContainerRuntime
    {
        ...
        public GameSceneUI()
        {
            ...
            _uiSoundEffect = content.Load<SoundEffect>("audio/MMX - Stage Cursor Move");
            TextureAtlas atlas = TextureAtlas.FromFile(content, "images/atlas-definition-2.xml");
        ...
        {
            // Button was clicked, play the ui sound effect for auditory feedback.
            Core.Audio.PlaySoundEffect(_uiSoundEffect).Volume = 0.7f;
            Core.Audio.PlaySoundEffect(_uiSoundEffect);
