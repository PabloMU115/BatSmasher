...
public class Tileset
{
    ...
    /// <summary>
    /// Gets the texture region for the tile 
    /// from this tileset at the given index.
    /// </summary>
    /// <param name="index">
    /// The index of the 
    /// texture region in this tile set.
    /// </param>
    /// <returns>
    /// The texture region for the 
    /// tile form this tileset at the given index.
    /// </returns>
