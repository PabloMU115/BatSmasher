...
public readonly struct Circle : IEquatable<Circle>
{
    ...
    /// <summary>
    /// Gets a value that indicates whether this circle 
    /// has a radius of 0 and a location of (0, 0).
    /// </summary>
    ...
    /// <summary>
    /// Returns a value that indicates if the circle on the 
    /// left hand side of the equality operator is equal to the
    ...
    /// <summary>
    /// Returns a value that indicates if the circle on the left 
    /// hand side of the inequality operator is not equal to the
